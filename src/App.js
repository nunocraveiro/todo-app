...
const App = () => {
  ...
  const [todos, setTodos] = useState(localStorage.getItem('todos') ? JSON.parse(localStorage.getItem('todos')) : [{id: 0, title: 'go to ada and get bounties', description: '', date: '17042023', added: false, completed: false}, {id: 1, title: 'do flawless lake of shadows', description: '', date: '17042023', added: false, completed: false}, {id: 2, title: 'finish thunderlord catalyst', description: '', date: '18042023', added: false, completed: false}]);
